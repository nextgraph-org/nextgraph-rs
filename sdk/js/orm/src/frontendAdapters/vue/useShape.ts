 ...
 * @returns A result object with data and utility properties (as refs).
 *
 * @example
 * ```html
 * <script lang="ts">
 ...
 *
 *
 * // Simply call $expenses.value.add({"@graph": "<g1 or g2 NURI>", "@id": "", title: "Example title"}), to add new elements.
