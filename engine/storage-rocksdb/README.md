...
Storage backend based on RocksDB for NextGraph
...
This library is used internally by [ngcli](../ngcli/README.md), [ng-app](../ng-app/README.md) and by [nextgraph, the Rust client library](../../sdk/rust/README.md) which you should be using instead. It is not meant to be used by other programs as-is.
