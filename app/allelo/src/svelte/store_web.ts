...
export const bootstrap_web = async function() {
    ...
    wallet_channel.onmessage = async (event) => {
        //console.log("wallet_channel on message",event.data.cmd, event.data);
        ...
        switch (event.data.cmd) {
            ...
            break;
            case "opened":
                //console.log("opened", get(opened_wallets)[event.data.wallet.id])
    ...
    //console.log("wallet_channel established");

    unsubscribe = active_wallet.subscribe(async (value) => {
        //console.log("got active_wallet", value)
        if (value) {
            if (value.wallet) {
                opened_wallets.update((w) => {
    ...
    //console.log("active_wallet.subscribe established");
