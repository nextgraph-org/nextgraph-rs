...
export interface Tag {
  ...
  valueIRI:
    ...
    | "did:ng:k:contact:tag#humane-tech"
    ...
    | "did:ng:k:contact:tag#venture-capital"
    | "did:ng:k:contact:tag#deep-tech"
    ...
    | "did:ng:k:contact:tag#career-development"
